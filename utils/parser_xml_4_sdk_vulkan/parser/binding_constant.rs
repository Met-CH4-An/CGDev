...
impl BindingConstant {
    ...
    ///
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    pub(in crate::parser) fn s_create(type_rng:RangeInclusive<usize>, value_rng:RangeInclusive<usize>, name_rng: RangeInclusive<usize>, comment_rng:RangeInclusive<usize>) -> Self {
        Self {
            type_rng: type_rng,
            value_rng: value_rng,
            name_rng: name_rng,
    ...
    pub unsafe fn appendsString(&self, data: &[u8], output: &mut String) {
        let type_str_ = std::str::from_utf8_unchecked(&data[*self.type_rng.start() ..= *self.type_rng.end()]);
        ...
        let output_str_ = &format!("pub const {}: {} = {}; // {}\n", value_str_, type_str_, name_str_, comment_str_);
