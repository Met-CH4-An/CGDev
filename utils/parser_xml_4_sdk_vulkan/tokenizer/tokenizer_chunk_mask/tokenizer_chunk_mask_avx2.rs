...
use crate::tokenizer::tokenizer::{TokenizerBackendAVX2};
...
where
TBackend: TokenizerBackendAVX2 {
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ///
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    unsafe fn s_buildMaskAVX2(src: __m256i, dst: __m256i) -> u32 {
    ...
    ///
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    unsafe fn s_buildMask3AVX2(src: __m256i, dst_1: __m256i, dst_2: __m256i, dst_3: __m256i) -> u32 {
    ...
    ///
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    unsafe fn s_buildMask4AVX2(src: __m256i, dst_1: __m256i, dst_2: __m256i, dst_3: __m256i, dst_4: __m256i) -> u32 {
    ...
    ///
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    unsafe fn s_buildMaskRngAVX2(src: __m256i, ascii_lowercase : __m256i, a : __m256i, z : __m256i) -> u32 {
...
TBackend: TokenizerBackendAVX2 {
    ...
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    pub unsafe fn buildAVX2(&mut self, data_cptr: *const u8) {
        unsafe {
            ...
            self.l_chevron_mask = Self::s_buildMaskAVX2(src_, self.registers.chevron_l);
            self.r_chevron_mask = Self::s_buildMaskAVX2(src_, self.registers.chevron_r);
            self.equal_mask = Self::s_buildMaskAVX2(src_, self.registers.equal);
            self.quote_mask = Self::s_buildMaskAVX2(src_, self.registers.quote);
            self.separators_mask = Self::s_buildMask4AVX2(src_, self.registers.sp, self.registers.tab, self.registers.lf, self.registers.cr);
            self.letters_digitals_mask = Self::s_buildMaskRngAVX2(src_, self.registers.ascii_lowercase, self.registers.letter_a, self.registers.letter_z);
            self.forward_slash = Self::s_buildMaskAVX2(src_, self.registers.slash);
            self.question_mark = Self::s_buildMaskAVX2(src_, self.registers.qm);
            self.exclamation_mark = Self::s_buildMaskAVX2(src_, self.registers.em);
