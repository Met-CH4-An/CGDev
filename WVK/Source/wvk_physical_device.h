		...
		*/
		...
		public:
			...
			*/
			...
			//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			/*!	\brief
			* Создаёт и инициализирует физическое Vulkan-устройство.
			*
			* @param[in] create_info
			*        Структура с параметрами инициализации физического устройства.
			*
			* @return
			...
			*        - FAIL с подробным сообщением об ошибке, если инициализация завершилась неудачно.
			*
			* @note
			*        Метод безопасно сбрасывает внутреннее состояние в случае ошибки.
			*
			* @code
