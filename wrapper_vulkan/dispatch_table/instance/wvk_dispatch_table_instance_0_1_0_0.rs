...
TLevel : WvkDispatchTableInstance, {
    ...
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    #[inline(always)]
    pub(crate) fn vkEnumeratePhysicalDevices(&self, instance: svk::svk_types::VkInstance, pPhysicalDeviceCount: *mut u32, pPhysicalDevices: *mut svk::svk_types::VkPhysicalDevice) -> svk::svk_enums::VkResult {
    ...
    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    #[inline(always)]
    pub(crate) fn vkGetPhysicalDeviceProperties(&self, physicalDevice: svk::svk_types::VkPhysicalDevice, pProperties: *mut svk::svk_structures::VkPhysicalDeviceProperties) {
