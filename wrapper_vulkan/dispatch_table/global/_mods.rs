...
use crate::dispatch_table::{private, WvkDispatchTableLevel, WvkDispatchTableGlobal, WVK_DISPATCH_TABLE_GLOBAL};
...
impl private::WvkDispatchTableLevelPrivate for WVK_DISPATCH_TABLE_GLOBAL {}
